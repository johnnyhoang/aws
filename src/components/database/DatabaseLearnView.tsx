...
import { DatabaseChapter } from '../../types/databaseModule';
import { 
  ChevronLeft, 
  ChevronRight, 
  Copy, 
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-8 text-slate-300">
      ...
      <div className="space-y-3 pb-6 border-b border-slate-800">
        <div className="flex items-center gap-2 text-xs font-semibold text-amber-400 uppercase tracking-wider">
          ...
          <span>Sách Chuyên Khảo Toàn Diện: Cơ Sở Dữ Liệu & Universal Free-DB Gateway</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <aside className="lg:col-span-4 space-y-2 lg:sticky lg:top-20">
            <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2 flex items-center justify-between">
              <span>Mục Lục 6 Chương</span>
              <span className="font-mono text-slate-500">{DATABASE_CHAPTERS.length} bài đọc</span>
            </div>

            <nav className="space-y-1">
              {DATABASE_CHAPTERS.map((ch, idx) => {
            ...
            {/* Quick Navigation to Test & Simulator */}
            {onNavigateTab && (
              <div className="pt-4 border-t border-slate-800/80 space-y-2 text-xs">
                ...
                >
                  <span>Kiểm tra trắc nghiệm & Thẻ nhớ DB</span>
                ...
                <button
                  ...
                  className="w-full py-2 px-3 rounded-md bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-amber-300 transition-colors text-left flex items-center justify-between cursor-pointer"
                >
                  <span>Mô phỏng MCP Gateway & Trình chọn DB</span>
                  <ChevronRight className="w-3.5 h-3.5 text-slate-500" />
                </button>
              </div>
            )}
